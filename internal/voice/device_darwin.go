...
// CoreAudio property selectors and scopes (FourCC constants from
// AudioHardware.h / AudioObject.h).
const (
...
// cfStringCreate returns a retained CFStringRef; the caller must
// cfRelease it.
