...
// TestNewClientWorkspace does not panic with nil client.
func TestNewClientWorkspace_NilClient(t *testing.T) {
	t.Parallel()
	ws := NewClientWorkspace(nil, proto.Workspace{
